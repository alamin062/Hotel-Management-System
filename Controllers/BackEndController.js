...
class BackEndController {
   //This part of code for rendering Home page
   static getHome = async (req, res) => {
      res.render("HomePage");
   };

   // To render contract page
   static getContact1 = async (req, res) => {
      res.render("ContactPage");
   };

   //This part of code for rendering Room Booking page
   ...
   //This part of code for stroing user contact in database
   ...
   // to get cutomer data from customer table and render those data in customer info page
   ...
   static createEmployeeInfo = async (req, res) => {
      try {
